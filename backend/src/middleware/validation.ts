...
export const validateCreateAccount = [
  ...
  body('accountType')
    .optional()
    .isIn(['DEMO', 'LIVE'])
    .withMessage('Account type must be either DEMO or LIVE'),
  ...
  body('maxDrawdown')
    .optional()
    .isFloat({ min: 0 })
    .withMessage('Max drawdown must be a positive number'),
  ...
  body('dataInfoName')
    .optional()
    .isLength({ max: 200 })
    .withMessage('Data info name must be less than 200 characters'),

  body('dataInfoPassword')
    .optional()
    .isLength({ max: 200 })
    .withMessage('Data info password must be less than 200 characters'),

  body('dataInfoNotes')
    .optional()
    .isLength({ max: 1000 })
    .withMessage('Data info notes must be less than 1000 characters'),
