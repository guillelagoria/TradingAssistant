        ...
        <CardContent className="pt-6">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h3 className="text-lg font-semibold text-blue-900 mb-1">Recommended Stop Loss</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <Card className="border-green-200 bg-green-50/50">
          <CardContent className="pt-6">
            ...
            <div className="space-y-2">
              <div>
                <p className="text-sm text-green-700">Average MAE</p>
        ...
        <Card className="border-red-200 bg-red-50/50">
          <CardContent className="pt-6">
            ...
            <div className="space-y-2">
              <div>
                <p className="text-sm text-red-700">Average MAE</p>
        ...
        <Card className="border-amber-200 bg-amber-50/50">
          <CardContent className="pt-6">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h4 className="font-semibold text-amber-900">Premature Stops</h4>
            </div>
            <div className="space-y-2">
              <div>
                <p className="text-sm text-amber-700">Could be avoided</p>
        ...
        <Card className="border-purple-200 bg-purple-50/50">
          <CardContent className="pt-6">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h4 className="font-semibold text-purple-900">Statistical Basis</h4>
            </div>
            <div className="space-y-2">
              <div>
                <p className="text-sm text-purple-700">75th Percentile MAE</p>
