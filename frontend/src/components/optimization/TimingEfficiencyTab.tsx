...
const TimingEfficiencyTab = ({ data }: Props) => {
  ...
  return (
    ...
    >
      {/* Main Insight Card */}
      <Card className="border-purple-300 bg-gradient-to-br from-purple-50 to-violet-100/50">
        <CardContent className="pt-6">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h3 className="text-lg font-semibold text-purple-900 mb-1">Timing Insights</h3>
              ...
              {data.bestEntryHours.map((hour, index) => (
                ...
                >
                  ...
                  <div className="text-right">
                    <p className={`text-lg font-bold ${hour.avgPnL >= 0 ? 'text-green-600' : 'text-red-600'}`}>
        ...
        <Card className="border-green-200 bg-green-50/50">
          <CardContent className="pt-6">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h4 className="font-semibold text-green-900">Winning Trades</h4>
            </div>
        ...
        <Card className="border-red-200 bg-red-50/50">
          <CardContent className="pt-6">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h4 className="font-semibold text-red-900">Losing Trades</h4>
            </div>
            <div className="space-y-2">
              <div>
                <p className="text-sm text-red-700">Average duration</p>
      ...
      <Card className="border-amber-200 bg-amber-50/50">
        <CardContent className="pt-6">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h4 className="font-semibold text-amber-900 mb-2">Suggested Time Stop</h4>
              <div className="mb-3">
          ...
          <CardContent className="pt-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 bg-white rounded-lg border border-indigo-200">
                <p className="text-sm text-indigo-700 mb-1">Reached Break-Even</p>
              ...
              <div className="p-4 bg-white rounded-lg border border-indigo-200">
                <p className="text-sm text-indigo-700 mb-1">Continued to Profit</p>
                <p className="text-2xl font-bold text-indigo-600">
