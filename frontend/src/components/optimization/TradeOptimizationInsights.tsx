...
const TradeOptimizationInsights = () => {
      ...
      <Card className="w-full border-amber-200 bg-amber-50/50">
        <CardHeader>
          <div className="flex items-center gap-2">
            ...
            <CardTitle className="text-amber-900">Trade Optimization Insights</CardTitle>
          </div>
        ...
        <CardContent>
          ...
          <div className="mt-4 p-4 bg-white rounded-lg border border-amber-200">
            <h4 className="text-sm font-medium text-amber-900 mb-2">Data Quality</h4>
            <div className="grid grid-cols-2 gap-3 text-sm">
              <div>
                <span className="text-amber-700">MAE/MFE Data:</span>
                <span className="ml-2 font-medium text-amber-900">
                  {insights.dataQuality.hasMAE} / {insights.currentTrades}
                </span>
              </div>
              <div>
                <span className="text-amber-700">Advanced Data:</span>
                <span className="ml-2 font-medium text-amber-900">
  ...
  return (
    ...
    >
      <Card className="w-full border-blue-200 bg-gradient-to-br from-blue-50/50 to-purple-50/50">
        <CardHeader>
          <div className="flex items-center gap-2">
            <TrendingUp className="h-5 w-5 text-blue-600" />
            <CardTitle className="text-blue-900">Trade Optimization Insights</CardTitle>
          </div>
